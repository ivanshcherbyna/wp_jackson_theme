...
//Register chemical styles & awessome fonts
function register_chemical_styles()
{
    wp_register_style('chemical_style_css', get_stylesheet_directory_uri() . '/inc/chemical-style.css');
    wp_register_style('awesome-icons-min', get_stylesheet_directory_uri().'/inc/font-awesome.min.css');

    wp_enqueue_style('chemical_style_css');
...
add_action('wp_enqueue_scripts','register_chemical_styles'); //ADD chemical styles
...
include_once 'inc/actions-frontend/front-page.php';
include_once 'inc/actions-frontend/videostream-shrotcode.php';
include_once  'inc/actions-frontend/menu_nav.php';
//Include parts 

function true_change_admin_footer () {
    $footer_text = array(
        'Thank you <a href="http://wordpress.org">WordPress</a>',
        'Develop by <a href="mailto:vanjok137@gmail.com" >Ivan Shcherbyna</a>'
    );
